...
**Two ways to connect your AI client:**

<Columns cols="2">
  <Card title="Local Site" icon="monitor">
    WordPress running on your own computer. Connects via WP-CLI using a direct command - no internet required.
  </Card>

  <Card title="Remote Site" icon="globe">
    WordPress hosted on a server or staging URL. Connects over HTTPS using your Application Password.
  </Card>
</Columns>
