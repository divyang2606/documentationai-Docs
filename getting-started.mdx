...
<Columns cols="3">
  <Card title="Guided Brief" href="/guided-brief" icon="clipboard">
    <Image src="https://res.cloudinary.com/doc8jbfej/image/upload/q_100/v1775211315/Scope-image_x9wjuf.webp" alt="" />
    Fill out a structured brief for detailed, client-ready project scoping.
  </Card>

  <Card title="Sitemap Editor" href="/sitemap-editor" icon="map">
    <Image src="https://res.cloudinary.com/doc8jbfej/image/upload/q_100/v1775211315/Sitemap-image_bu3xoo.webp" alt="" />
    Add pages, reorder sections, and refine your site structure before designing.
  </Card>

  <Card title="Design Editor" href="/design-editor" icon="palette">
    <Image src="https://res.cloudinary.com/doc8jbfej/image/upload/q_100/v1775211315/Design-image_e7exsw.webp" alt="" />
