...
<Columns cols="2">
  <Card title="WordPress Core" href="#wordpress-core" icon="layout">
    Posts, pages, users, menus, media, taxonomies, and comments. The full WordPress data layer in ~40 abilities.
  </Card>

  <Card title="Files & Theme" href="#file-operations" icon="file-text">
    Read and write files across the WordPress filesystem, plus direct access to active theme files.
  </Card>

  <Card title="PHP Execution" href="#php-execution-and-sandbox" icon="code">
    Run PHP directly in your live WordPress environment with full access to all WordPress APIs.
  </Card>

  <Card title="Page Builders" href="#elementor" icon="layers">
    Elementor, TPAE, cross-builder, and Bricks. Deep access to the underlying builder data layer.
  </Card>

  <Card title="WooCommerce" href="#woocommerce" icon="shopping-cart">
    Products, orders, categories, and sales reports. Only registers when WooCommerce is active.
  </Card>

  <Card title="Bridge Tools" href="#bridge-tools" icon="git-branch">
