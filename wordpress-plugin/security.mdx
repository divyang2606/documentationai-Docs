...
<Columns cols="2">
  <Card title="Safe Mode" href="#safe-mode" icon="shield">
    One toggle makes every ability read-only. AI can explore your site without writing, editing, or executing anything.
  </Card>

  <Card title="Ability Manager" href="#ability-manager" icon="sliders">
    Enable or disable any of the 175+ abilities individually. Restrict exactly what your AI can touch and nothing more.
  </Card>

  <Card title="Protected Files" href="#whats-always-protected" icon="lock">
    Core files and directories are always blocked - regardless of which abilities are enabled.
  </Card>

  <Card title="Safety Controls" href="#more-safety-controls" icon="settings">
    Rate Limiter, Crash Guard, Audit Log, Meta Snapshots, Domain Lock, and per-call approval - all configurable.
  </Card>
</Columns>
