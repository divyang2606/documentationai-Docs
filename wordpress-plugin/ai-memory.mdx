...
<Callout kind="tip">
  **Three tools in one.** AI Memory replaces three things that used to be separate concepts: custom instructions, skills, and long-term memory. A memory set to Always applied is what other tools call a "custom instruction." A memory with a slug is what other tools call a "skill." Plain memories are memories. Less to learn, one place to audit.
</Callout>
