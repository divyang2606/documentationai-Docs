...
description: >-
  AI Memory gives SproutOS a persistent memory of your project rules, context, brand, and resources - so the agent works with full context on every session without you repeating yourself.
---

AI Memory is a persistent memory system built into SproutOS. It stores your project context, house rules, brand profile, and external resource pointers directly in WordPress, then injects them into the agent automatically at the start of every session. The agent already knows your rules, your site, and your preferences before you type a single message.
