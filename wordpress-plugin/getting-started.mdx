...
<Steps>
  ...
  <Step title="Choose a Capability Profile">
    Capability Profiles control how many of SproutOS's 175+ abilities load at the start of each session. The default is **Minimal** - the right choice for most workflows.

    Change it anytime from **SproutOS > AI Abilities**. See [Capability Profiles](/wordpress-plugin/capability-profiles) to compare all four options.
  </Step>
</Steps>
