...
<Steps>
  ...
  <Step title="Verify the connection">
    ...
    If connected, the AI will return a file listing from your site. If it doesn't respond as expected, check the [Troubleshooting guide](/wordpress-plugin/troubleshooting) for common issues.
  </Step>
