...
The MCP Adapter is the official WordPress plugin that bridges the Abilities API to the MCP protocol. SproutOS requires it.
...
<Callout kind="info">
  The MCP Adapter exposes WordPress abilities over HTTP. Without it, AI clients cannot communicate with your site.
</Callout>

## Step 2: Install the SproutOS Plugin
...
## Step 6: Configure Abilities (Optional)
