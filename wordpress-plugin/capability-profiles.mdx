...
Go to **SproutOS > AI Abilities** and select a profile from the **Capability Profile** selector. The change takes effect on the next session - your current connection will use the profile it started with.

You can switch profiles anytime without affecting your abilities, sandbox files, or analytics data.
