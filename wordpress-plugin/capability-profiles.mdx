...
<Steps>
  <Step title="Open AI Abilities">
    In your WordPress admin, go to **SproutOS > AI Abilities**.
  </Step>

  <Step title="Choose a profile">
    Find the **Capability Profile** selector and pick the profile that fits your workflow.
  </Step>

  <Step title="Reconnect your AI client">
    The change takes effect on the next session. Disconnect and reconnect your AI client to start using the new profile.
  </Step>
</Steps>
