...
<Columns cols="2">
  <Card title="4 Profiles" href="#what-profiles-are-available" icon="sliders">
    Ultra-Minimal to Full. Pick what loads upfront and save tokens without losing access to any ability.
  </Card>

  <Card title="Bridge Tools" href="#how-does-my-ai-reach-abilities-not-loaded-upfront" icon="git-branch">
    Three always-available tools let your AI discover and call any ability on demand, in any profile.
  </Card>

  <Card title="Choose the Right Profile" href="#which-profile-to-choose" icon="check-square">
    Quick reference for matching profiles to workflows - from live-site audits to deep builder work.
  </Card>

  <Card title="Switching Profiles" href="#how-do-i-switch-my-capability-profile" icon="refresh-cw">
