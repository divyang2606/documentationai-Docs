...
Each memory card in the list shows the type icon, name, description, status chip, byline (author and last edited by), relative timestamp, an archive toggle switch, and a three-dot menu with Edit, Pin, Unpin, and Delete options.
